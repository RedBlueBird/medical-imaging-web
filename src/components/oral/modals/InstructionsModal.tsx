    ...
    >
      <div className="p-6 space-y-4">
        <div className={`${colors.textSecondary} leading-relaxed`}>
          <p className="mb-4">你可以选择（1）上传单张图片进行检测（支持jpg, jpeg, png格式）；</p>
          <p className="mb-4">或者选择（2）上传一个按照指定格式排列好的图片文件夹。</p>
          <p className="mb-4">这个文件夹内部的子文件夹格式应为：</p>
          <div className="bg-white/5 p-4 rounded-lg font-mono text-sm mb-4">
            "患者姓名-主病案号-病名（历史诊断）-YYMMDD-Y有活检确认N无活检确认"
          </div>
          <p className="mb-4">例如：张三-88888888-口腔扁平苔藓-250101-N</p>
